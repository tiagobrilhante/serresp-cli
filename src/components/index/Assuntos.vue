<template>
  ...
  <v-container fill-height fluid>
    ...
    <v-row>
      <v-col class="text-center"><h1>Atividadeds Recentes</h1></v-col>
    </v-row>
      ...
      <v-col>
          ...
          <v-col :key="la1.id" align-self="center" cols="4" v-for="la1 in linha1assuntos" v-if="la1 !== undefined">
            ...
            >
              ...
              <v-card-text class="text-center pa-2">
                <v-img :height=configBasica.altura_index :src="configSis.urlDownload + la1.banner.imagem"
        ...
        <v-row>
          <v-col :key="la2.id" align-self="center" cols="4" v-for="la2 in linha2assuntos" v-if="la2 !== undefined">
            ...
            >
              <v-card-text class="text-center pa-2">
                ...
                <v-img :height=configBasica.altura_index :src="configSis.urlDownload + la2.banner.imagem"
                       :width=configBasica.largura_index
                       class="rounded-xl ml-auto mr-auto"/>
          ...
          <v-col :key="n" align-self="center" cols="4" v-for="n in 3-countUndefined2"
            ...
            <v-alert :height=configBasica.altura_index :width=configBasica.largura_index
    ...
    <v-dialog max-width="90%" v-model="dialogNavegaAssunto" scrollable>
      <v-card color="#a8b7f0" @contextmenu.prevent="disableRightClick" v-if="!objetoVazio(selectedAssunto)">
        ...
        <v-card-text>
          ...
          <v-row class="mt-2" justify="center">
            <v-col align-self="center" class="text-center">
              ...
              <v-img :height=configBasica.altura_detail :src="configSis.urlDownload + selectedImg.imagem"
